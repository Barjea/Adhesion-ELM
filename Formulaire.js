...
// ===========================================================================
const GAS_EXEC_URL = "https://script.google.com/macros/s/AKfycbynTYKWQ1Y4RDr9U04nmTjL9_mUhBORjyLCe0UivlEX6FBNLGoElYCUgvucHqc4Ryc/exec";
...
function initFormulaire() {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      // --- TRACES DE DEBUG ---
      console.log("👉 URL cible :", GAS_EXEC_URL);[cite: 4]
      console.log("👉 Token global dans l'IHM :", token);[cite: 4]
      console.log("👉 Données extraites du formulaire (data) :", data);[cite: 4]
